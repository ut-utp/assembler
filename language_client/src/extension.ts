...
export async function activate(context: ExtensionContext) {
  ...
  const command = process.env.SERVER_PATH || "lc3-language-server";
  ...
  let clientOptions: LanguageClientOptions = {
    ...
    documentSelector: [{ scheme: "file", language: "lc3" }],
    synchronize: {
  ...
  client = new LanguageClient("lc3-language-server", "LC-3 language server", serverOptions, clientOptions);
